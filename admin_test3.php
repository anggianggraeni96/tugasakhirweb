                        ...
                        <div class="panel-body">
                            <table align="center" border="3">
                                ...
                                <?php
                                    ...
                                    $sql = mysqli_query($koneksi, "select * from sesi_3"); //query select
                                    foreach ($sql as $row) { //Print : data
                                        ...
                                        <td>".$row['jumlah']."</td>
                                        <td>
                                            <a href='update3.php?id=$row[nomor]'>Edit</a> 
                                            <a href='delete3.php?id=$row[nomor]'>Hapus</a>
                                        </td>
                                        </tr>";              
                                        }
                                    ?>
                                ...
                                <!-- button cetak -->
                                <button onclick="location.href='reportpdf3.php';" id="reportpdf" type="button" class="btn btn-info">Cetak PDF</button>
                                <button onclick="location.href='reportexcel3.php';" id="reportexcel" type="button" class="btn btn-success">Export Excel</button>
                                <br><br>
                        </div>
                    </div>
                </div>
