...
<head>
    ...
    <?php
       ...
       $sql = mysqli_query($koneksi, "select * from sesi_2 where nomor='$id'");
            ...
            <div id="page-inner">
                ...
                <div class="col-md-12 col-sm-0">
                    <div class="panel">
                        ...
                        <form method="POST" action="updateAct2.php"> <!--form dengan method post-->
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <a href="admin_test2.php">Kembali</a> <!--Kembali ke admin.php-->
                                        </td>
                                    </tr>
                                </table>
                            </form>
