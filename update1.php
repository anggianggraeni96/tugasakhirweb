...
<head>
    ...
    <?php
       ...
       $sql = mysqli_query($koneksi, "select * from sesi_1 where nomor='$id'");
            ...
            <div id="page-inner">
                ...
                <div class="col-md-12 col-sm-0">
                    <div class="panel">
                        ...
                        <form method="POST" action="updateAct1.php"> <!--form dengan method post-->
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <a href="admin.php">Kembali</a> <!--Kembali ke admin.php-->
                                        </td>
                                    </tr>
                                </table>
                            </form>
